...
<title>Gerência</title>
 ...
 <script>
  ...
  <div class='user-container' 
    ...
    <a href='#'>Olá, <?php echo $primeiraLetra; ?></a> <!-- Exibe o primeiro nome -->
 ...
 <TABLE  ALIGN='CENTER'>  <td>   <input type='button' value='cadastrar produto'
               onClick=\"abrirPopupPost('cadprod.php')\">
    </td>
